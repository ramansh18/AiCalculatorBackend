...
f"6. Logic-based problems or puzzles represented visually, like Sudoku, flowcharts, or other logic puzzles. For these, return the correct answer in the format [{{'expr': 'description of problem', 'result': 'calculated answer'}}]. "
...
f"ADDITIONAL RULES: "
f"- If no equation or mathematical expression is found in the image, return an empty list. "
f"- If the expression is not solvable (e.g., incomplete equation or undefined variable), return a message stating 'Expression cannot be solved.' "
f"- If a graphical problem involves multiple steps, provide a brief breakdown of how the problem was solved. "
f"- If there are any ambiguities in the expression, clarify the assumptions made during the solving process (e.g., assuming missing operators or constants). "
f"- Always ensure the format of the response is a list of dictionaries, even if there is only one solution."
